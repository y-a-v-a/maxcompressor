...
function postToTumblr(image, tags) {
  ...
  var client = tumblr.createClient({
    consumer_key: process.env.TUMBLR_CONSUMER_KEY || config.consumer_key,
    consumer_secret:
      process.env.TUMBLR_CONSUMER_SECRET || config.consumer_secret,
    token: process.env.TUMBLR_TOKEN || config.token,
    token_secret: process.env.TUMBLR_TOKEN_SECRET || config.token_secret,
  });
